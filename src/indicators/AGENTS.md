# AGENTS.md — Indicator Library

Scope: `src/indicators/`. Root [`AGENTS.md`](../../AGENTS.md) stays canonical for system-wide policy; this file adds package-specific detail and never overrides it.
